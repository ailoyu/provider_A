...
public class MyContentProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "com.example.providers_a";
    ...
    static {
        ...
        uriMatcher.addURI(AUTHORITY, AUTHOR_TABLE, ONE);
        uriMatcher.addURI(AUTHORITY, AUTHOR_TABLE + "/#", ALL);
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        long number_row = db.insert(AUTHOR_TABLE,"", values);
        if(number_row > 0){
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        queryBuilder.setTables(AUTHOR_TABLE);
